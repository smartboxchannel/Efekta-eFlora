...
const definition = {
        ...
        fromZigbee: [fz.temperature, fz.illuminance, fz.humidity, fz.soil_moisture, fz.battery, fzLocal.node_config, fzLocal.config_disp, fzLocal.sm_config, fzLocal.node_debug],
        toZigbee: [tz.factory_reset, tzLocal.node_config, tzLocal.sm_config, tzLocal.config_disp, tzLocal.node_debug],
        configure: async (device, coordinatorEndpoint, logger) => {
            const firstEndpoint = device.getEndpoint(1);
            await reporting.bind(firstEndpoint, coordinatorEndpoint, [
                'genBasic', 'genPowerCfg', 'genTime', 'msTemperatureMeasurement', 'msRelativeHumidity', 'msIlluminanceMeasurement', 'msSoilMoisture']);
        },
